                             ...
                             <tr>
                              ...
                              <tr>
                                <th colspan="4" style="text-align:center">
                                    <button type="button" name="save" data-id="hello" id="editMhsPerformance" class="btn btn-success" value="save">
...
//            setTimeout(hidetab,4000);
    ...
    $("#editMhsPerformance").click(function(){
      $("#editMhsPerformance").html('<img src="<?php echo base_url();?>site/content/img/loading.gif" style="width:25px;height:20px;" />');
      $Month= $("#Month").val();
      ...
      $CM= $("#CM").val();
      $Remark= $("#Remarks").val();
      $.post('<?php echo base_url();?>mhsPerformance/update/<?php echo $param2; ?>', { Month: $Month,monthid:$monthid,year:$year,Equipment:$Equipment,RN:$RN,BD:$BD,PM:$PM,CM:$CM,Remark:$Remark }, function(data){
          //alert(data);
                    if(data==1)
                          {                                  
                                $(".success_msg").html('<i class="material-icons">check_circle_outline</i> MHS Performance Details Updated Successfully');
                                $(".success_msg").show();
                                ...
                                setTimeout(hidetab,4000);
                                  ...
                                  $(".error_msg").show();
                                  setTimeout(hidetab,4000);
                                  $("#editMhsPerformance").html('Update');
                          }
		});
