                        ...
                        <div class="col-lg-12">
                             ...
                             <div class="card alert">
                                 ...
                                 <div class="addbtn">
                                  ...
                                  <div class="addbtn">
                                      <button data-toggle="modal" onclick="showAjaxModal('<?php echo base_url();?>home/popup/jsw/addPortOperational/<?php echo $Type;?>');" class="btn btn-info" style="float: right" > <i class="material-icons">add_circle_outline</i> Add Port Operational</button>
                             </div>
