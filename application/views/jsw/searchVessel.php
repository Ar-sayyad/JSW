    ...
    <div class="wrapper">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card">
                ...
                <form action="<?php echo base_url();?>vesselPerformance/searchVessel" method="POST" enctype="multipart/form-data">
                            ...
                            <tr>
                                ...
                                <th>
                                    <select id="month" name="month" placeholder="month" required="" class="clsmon form-control">
                                        ...
                                        <option data-id="<?php echo trim($mon['FY_Order']);?>" value="<?php echo trim($sr);?>"><?php echo trim($mon['MonName']);?></option>                                      
                                         <?php $sr++;}?>  
                                    </select>
                                </th></tr>
                        <tr>
